...
public class BitTorrentServer 
{
    ...
    private static class Handler extends Thread 
	{
            ...
            try 
			{
                ...
                try 
				{
                    while (true) 
					{
                        ...
                        // Process the message and generate a response (simulated response)
		...
		{
            // Add your logic here to handle different BitTorrent messages
            // Simulate sending a response message (modify this part)
